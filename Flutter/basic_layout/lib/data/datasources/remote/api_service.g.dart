...
class _ApiService implements ApiService {
  _ApiService(
    ...
    baseUrl ??= 'https://67c819070acf98d07084d306.mockapi.io';
  }
  ...
  Future<List<TodoDto>> getTodo() async {
    ...
    final _options = _setStreamType<List<TodoDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<TodoDto> addTodo(TodoDto todo) async {
    ...
    final _options = _setStreamType<TodoDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
